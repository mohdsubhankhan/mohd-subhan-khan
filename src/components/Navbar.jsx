        ...
        <div className="flex justify-between items-center py-2 md:py-4 md:px-2 pl-2 mx-auto">
          <div className="flex items-center cursor-pointer">
            <a
              ...
              className={
                darkMode
                  ? "flex gap-2 text-xl font-medium text-decoration-none whitespace-nowrap text-black"
              ...
              {links.map((el) => (
                <li key={el.name} className="cursor-pointer">
                  <Link
                    ...
                    className={
                      darkMode
                        ? "block py-2 px-3 text-black hover:bg-blue-500 active:bg-blue-500 focus:bg-blue-500 hover:text-white rounded-md"
                        : "block py-2 px-3 text-white hover:bg-blue-500 active:bg-blue-500 focus:bg-blue-500 hover:text-white rounded-md"
                    }
                  >
                    {el.name}
                  </Link>
